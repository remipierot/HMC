...
public:
	...
	{
		Position = NYVert3Df((MAT_X_SIZE_CUBES*NYCube::CUBE_SIZE) / 2, (MAT_Y_SIZE_CUBES*NYCube::CUBE_SIZE) / 2, (MAT_Z_SIZE_CUBES*NYCube::CUBE_SIZE) * 2);
		Height = 15;
	...
	void render(void)
	{
		NYVert3Df fwd = Cam->_Direction * NYCube::CUBE_SIZE * rayLength;
